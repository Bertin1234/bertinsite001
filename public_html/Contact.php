...
<div class="header">
  <div class="gridContainer clearfix" id="header-inner">
    ...
    <div class="textbox" id="navigation">
...
<div id="footer">
  <div class="gridContainer clearfix" id="footer-inner">
    <div id="footer-left">
    <i style="margin-left:0;" class="icon-home"></i> 987 Pleasant Street Brockton MA 02301.
