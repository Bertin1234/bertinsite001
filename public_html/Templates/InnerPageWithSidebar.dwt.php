...
<div class="gridContainer clearfix" id="content-wrap">
  ...
  <div id="ProductImage"><!-- TemplateBeginEditable name="Image" --><img src="http://placehold.it/860x610/A2DEE3/fff&text=Product/Project+Image" alt=""><!-- TemplateEndEditable --></div>
  <div id="Sidebar"><!-- TemplateBeginEditable name="Sidebar" -->
    <h4>Description</h4>
